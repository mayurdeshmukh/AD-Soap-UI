...
resource "aws_lb_target_group" "jd-soap-app4-blue" {
...
resource "aws_lb_listener_rule" "listener-rule-app4" {
  listener_arn = data.aws_lb_listener.blue-listener.arn
  # priority     = 100

  action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.jd-soap-app4-blue.arn
  }
...
resource "aws_lb_target_group" "jd-soap-app4-green" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app4-green.arn
#   }
...
# resource "aws_lb_listener" "jd-soap-app4" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app4.arn
#   }
# }
