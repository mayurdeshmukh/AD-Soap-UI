...
# resource "aws_codedeploy_app" "app6" {
#   compute_platform = var.compute_platform
#   name             = var.aws_codedeploy_app_name
# }

# resource "aws_codedeploy_deployment_group" "this" {
#   app_name               = aws_codedeploy_app.app6.name
#   deployment_config_name = var.deployment_config_name
...
#     service_name = aws_ecs_service.jd-soap-app6.name
#   }
...
#       target_group {
#         name = aws_lb_target_group.jd-soap-app6-blue.name
#       }

#       target_group {
#         name = aws_lb_target_group.jd-soap-app6-green.name
#       }
#     }
#   }
# }