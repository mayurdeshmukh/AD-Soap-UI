...
resource "aws_lb_target_group" "jd-soap-app6-blue" {
...
resource "aws_lb_listener_rule" "listener-rule-app6" {
  listener_arn = data.aws_lb_listener.blue-listener.arn
  # priority     = 100

  action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.jd-soap-app6-blue.arn
  }
...
resource "aws_lb_target_group" "jd-soap-app6-green" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app6-green.arn
#   }
...
# resource "aws_lb_listener" "jd-soap-app6" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app6.arn
#   }
# }
