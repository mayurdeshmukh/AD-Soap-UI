...
# resource "aws_codedeploy_app" "app3" {
#   compute_platform = var.compute_platform
#   name             = var.aws_codedeploy_app_name
# }

# resource "aws_codedeploy_deployment_group" "this" {
#   app_name               = aws_codedeploy_app.app3.name
#   deployment_config_name = var.deployment_config_name
...
#     service_name = aws_ecs_service.jd-soap-app3.name
#   }
...
#       target_group {
#         name = aws_lb_target_group.jd-soap-app3-blue.name
#       }

#       target_group {
#         name = aws_lb_target_group.jd-soap-app3-green.name
#       }
#     }
#   }
# }