...
resource "aws_lb_target_group" "jd-soap-app3-blue" {
...
resource "aws_lb_listener_rule" "listener-rule-app3" {
  listener_arn = data.aws_lb_listener.blue-listener.arn
  # priority     = 100

  action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.jd-soap-app3-blue.arn
  }
...
resource "aws_lb_target_group" "jd-soap-app3-green" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app3-green.arn
#   }
...
# resource "aws_lb_listener" "jd-soap-app3" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app3.arn
#   }
# }
