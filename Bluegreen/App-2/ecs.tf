...
resource "aws_ecs_task_definition" "jd-soap-app2" {
...
resource "aws_ecs_service" "jd-soap-app2" {
  name                              = var.ecs_service_name
  cluster                           = data.aws_ecs_cluster.ecs_cluster.arn
  task_definition                   = aws_ecs_task_definition.jd-soap-app2.arn
  ...
  depends_on = [
    aws_ecs_task_definition.jd-soap-app2,
  ]
