...
resource "aws_lb_target_group" "jd-soap-app1-blue" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app1-blue.arn 
#   }
...
resource "aws_lb_target_group" "jd-soap-app1-green" {
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.jd-soap-app1-green.arn
#   }
...
resource "aws_lb_listener_rule" "listener-rule-app1" {
...
# resource "aws_lb_listener" "jd-soap-app1" {
